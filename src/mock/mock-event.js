...
const generateOffers = (eventType) => {
  ...
  // const a = offers.slice().filter((offer) => offer.type === eventType && offer.isChecked).slice(getRandomNum(0, OFFERS_MAX_NUM));
  // console.log(a);
  // for (let i = 0; i < getRandomNum(0, OFFERS_MAX_NUM); i++) {
  //   const newOffer = offers[getRandomNum(1, offers.length - 1)];
